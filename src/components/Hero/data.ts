...
export const heroTips = [
  ...
  `Simply switching your current account won't affect your credit score. However, your new bank might conduct a credit check which will show up on your credit report. Check out our 'Resources' section to find out more about what this might mean for you.`,
  `Having trouble convincing friends and family to make the switch? Check out the 'Tell Your Community' stage of your switching journey. Or, get up to speed with some case studies from our blog and 'Resources' section to add some flavour to your pitch.`,
  'When choosing a green bank, think about your needs as well as your values. Some of our recommended providers have great app features, while others have local branches, and some offer student banking. You can compare all the options here in the dashboard when selecting your new provider.',
  `Once you've scheduled in your switch, avoid setting up new standing orders or direct debits with your old account details within seven days of your switch date. Any new recurring payments set up during this time won't automatically make the switch to your new account, while all existing ones will be guaranteed through the Current Account Switch Service.`,
  'In the unlikely event that anything goes wrong with your switch, your new bank will refund any interest and charges you incur. This is part of the Current Account Switch guarantee. Get in touch with your new bank to sort out any unexpected hiccups. ',
  `Ready to make the switch today? You'll need some photo ID to hand - and while you're up, grab some proof of address such as a driver's licence, bank statement, or utility bill. Got it? You're good to go.`,
]
